...
<body class="font-poppins text-cp-black">
    <div id="header" class="bg-[#F6F7FA] relative overflow-hidden">
            ...
            <nav class="flex flex-wrap items-center justify-between bg-white p-[20px_30px] rounded-[20px] gap-y-3">
                <div class="flex items-center gap-3">
                    <div class="flex shrink-0 h-[43px] overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/logo/logo.svg') }}" class="object-contain w-full h-full"
                            alt="logo">
                    </div>
            ...
            <div id="Hero" class="flex flex-col gap-[30px] mt-20 pb-20">
                <div class="flex items-center bg-white p-[8px_16px] gap-[10px] rounded-full w-fit">
                    <div class="w-5 h-5 flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/crown.svg') }}" class="object-contain"
                            alt="icon">
                    </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button class="bg-cp-black p-5 w-fit rounded-xl font-bold text-white flex items-center gap-[10px]"
                        ...
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/icons/play-circle.svg') }}"
        ...
        <div class="absolute w-[43%] h-full top-0 right-0 overflow-hidden z-0">
            <img src="{{ asset('frontend/src/assets/backgrounds/banner.jpg') }}" class="object-cover w-full h-full"
                alt="banner">
        </div>
    </div>
        ...
        <div class="logo-container flex flex-wrap gap-5 justify-center">
            <div
                ...
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-54.svg') }}" class="object-contain w-full h-full"
                        alt="logo">
                </div>
            </div>
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-52.svg') }}" class="object-contain w-full h-full"
                        alt="logo">
                </div>
            </div>
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-55.svg') }}" class="object-contain w-full h-full"
                        alt="logo">
                </div>
            </div>
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-44.svg') }}" class="object-contain w-full h-full"
                        alt="logo">
                </div>
            </div>
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-51.svg') }}" class="object-contain w-full h-full"
                        alt="logo">
                </div>
            </div>
            <div
            ...
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-52.svg') }}"
            ...
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-54.svg') }}"
                        class="object-contain w-full h-full" alt="logo">
                </div>
            </div>
            <div
                class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300">
                <div class="overflow-hidden h-9">
                    <img src="{{ asset('frontend/src/assets/logo/logo-51.svg') }}"
                        class="object-contain w-full h-full" alt="logo">
                </div>
            </div>
        </div>
    ...
    <div id="OurPrinciples" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-20">
        ...
        <div class="flex flex-wrap items-center gap-[30px] justify-center">
            ...
            <div
                class="card w-[356.67px] flex flex-col bg-white border border-[#E8EAF2] rounded-[20px] gap-[30px] overflow-hidden hover:border-cp-dark-blue transition-all duration-300">
                <div class="thumbnail h-[200px] flex shrink-0 overflow-hidden">
                    <img src="{{ asset('frontend/src/assets/thumbnails/cover2.jpg') }}"
                        class="object-cover object-center w-full h-full" alt="thumbnails">
                </div>
                <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/user-octagon.svg') }}"
                            class="w-full h-full object-contain" alt="icon">
                    </div>
                    <div class="flex flex-col gap-1">
            ...
            <div
                class="card w-[356.67px] flex flex-col bg-white border border-[#E8EAF2] rounded-[20px] gap-[30px] overflow-hidden hover:border-cp-dark-blue transition-all duration-300">
                <div class="thumbnail h-[200px] flex shrink-0 overflow-hidden">
                    <img src="{{ asset('frontend/src/assets/thumbnails/cover3.jpg') }}"
                        class="object-cover object-center w-full h-full" alt="thumbnails">
                </div>
                <div class="flex flex-col p-[0_30px_30px_30px] gap-5">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/building-4.svg') }}"
                            class="w-full h-full object-contain" alt="icon">
                    </div>
                    <div class="flex flex-col gap-1">
        ...
        <div class="container max-w-[1000px] mx-auto py-10">
            <div class="flex flex-wrap items-center justify-between p-[10px]">
                <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/cup.svg') }}"
                ...
                <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/buildings.svg') }}"
                            class="object-contain w-full h-full" alt="icon">
                    </div>
                ...
                <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/status-up.svg') }}"
                            class="object-contain w-full h-full" alt="icon">
                    </div>
                ...
                <div class="card w-[200px] flex flex-col items-center gap-[10px] text-center">
                    <div class="w-[55px] h-[55px] flex shrink-0 overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/icons/star.svg') }}"
                            class="object-contain w-full h-full" alt="icon">
                    </div>
    ...
    <div id="Products" class="container max-w-[1130px] mx-auto flex flex-col gap-20 mt-20">
        <div class="product flex flex-wrap justify-center items-center gap-[60px] even:flex-row-reverse">
            <div class="w-[470px] h-[550px] flex shrink-0 overflow-hidden">
                <img src="{{ asset('frontend/src/assets/thumbnails/product cover one.png') }}"
        ...
        <div class="product flex flex-wrap justify-center items-center gap-[60px] even:flex-row-reverse">
            <div class="w-[470px] h-[550px] flex shrink-0 overflow-hidden">
                <img src="{{ asset('frontend/src/assets/thumbnails/product cover two.png') }}"
                    class="w-full h-full object-contain" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-[30px] py-[50px] h-fit max-w-[500px]">
                <p
        ...
        <div class="product flex flex-wrap justify-center items-center gap-[60px] even:flex-row-reverse">
            <div class="w-[470px] h-[550px] flex shrink-0 overflow-hidden">
                <img src="{{ asset('frontend/src/assets/thumbnails/product cover three.png') }}"
                    class="w-full h-full object-contain" alt="thumbnail">
            </div>
            <div class="flex flex-col gap-[30px] py-[50px] h-fit max-w-[500px]">
                <p
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="w-[90px] h-[90px] rounded-full overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/photos/photo1.png') }}"
        ...
        <div class="main-carousel w-full">
            <div
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        <div class="h-9 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/logo/logo-54.svg') }}" class="object-contain"
                                alt="icon">
                        </div>
                        <div class="relative pt-[27px] pl-[30px]">
                            <div class="absolute top-0 left-0">
                                <img src="{{ asset('frontend/src/assets/icons/quote.svg') }}" alt="icon">
                            </div>
                        ...
                        <div class="flex items-center justify-between pl-[30px]">
                            ...
                            <div class="flex flex-nowrap">
                                <div class="w-6 h-6 flex shrink-0">
                                    <img src="{{ asset('frontend/src/assets/icons/Star-rating.svg') }}"
                                        alt="star">
                                </div>
                                <div class="w-6 h-6 flex shrink-0">
                                    <img src="{{ asset('frontend/src/assets/icons/Star-rating.svg') }}"
                ...
                <div class="testimonial-thumbnail w-[470px] h-[550px] rounded-[20px] overflow-hidden bg-[#D9D9D9]">
                    <img src="{{ asset('frontend/src/assets/backgrounds/banner.jpg') }}"
            ...
            <div
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        <div class="h-9 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/logo/logo-51.svg') }}" class="object-contain"
                                alt="icon">
                        </div>
                        <div class="relative pt-[27px] pl-[30px]">
                            <div class="absolute top-0 left-0">
            ...
            <div
                ...
                <div class="testimonial-container flex flex-col gap-[112px] w-[565px]">
                    <div class="flex flex-col gap-[30px]">
                        <div class="h-9 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/logo/logo-44.svg') }}" class="object-contain"
                                alt="icon">
                        </div>
                        <div class="relative pt-[27px] pl-[30px]">
                            <div class="absolute top-0 left-0">
        ...
        <div
            ...
            <div
                ...
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('frontend/src/assets/icons/cup-blue.svg') }}" alt="icon">
                </div>
                    ...
                    <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
                        <button class="accordion-button flex justify-between gap-1 items-center"
                            ...
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src="{{ asset('frontend/src/assets/icons/arrow-circle-down.svg') }}"
    ...
    <footer class="bg-cp-black w-full relative overflow-hidden mt-20">
        <div
            ...
            <div class="flex flex-col gap-10">
                <div class="flex items-center gap-3">
                    <div class="flex shrink-0 h-[43px] overflow-hidden">
                        <img src="{{ asset('frontend/src/assets/logo/logo.svg') }}"
                            class="object-contain w-full h-full" alt="logo">
                    </div>
                    <div class="flex flex-col">
                ...
                <div class="flex items-center gap-4">
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/icons/youtube.svg') }}"
                                class="w-full h-full object-contain" alt="youtube">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/icons/whatsapp.svg') }}"
                                class="w-full h-full object-contain" alt="whatsapp">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/icons/facebook.svg') }}"
                                class="w-full h-full object-contain" alt="facebook">
                        </div>
                    </a>
                    <a href="">
                        <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                            <img src="{{ asset('frontend/src/assets/icons/instagram.svg') }}"
    ...
    <script src="{{ asset('frontend/src/js/carousel.js') }}"></script>
    <script src="{{ asset('frontend/src/js/accordion.js') }}"></script>

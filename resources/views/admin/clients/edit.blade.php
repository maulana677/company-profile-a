    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('admin.clients.index') }}">Clients</a></div>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                On this page, you can edit an existing client and update the required fields.
            </p>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#image-preview').css({
                'background-image': 'url("{{ asset('storage/' . $client->avatar) }}")',

...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">All About</h2>
            <p class="section-lead">
                On this page, you can see all the about data.
            </p>
                                    ...
                                    <tbody>
                                        @foreach ($abouts as $about)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($about->thumbnail)
                                                        <img src="{{ asset('storage/' . $about->thumbnail) }}"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.abouts.destroy', $about->id) }}"

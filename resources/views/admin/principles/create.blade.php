...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Create Principle</h2>
            <p class="section-lead">
                On this page, you can create a new principle and fill in all the required fields.
            </p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.principles.store') }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="subtitle" class="form-control" rows="3">{{ old('subtitle') }}</textarea>
                                        @error('subtitle')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
